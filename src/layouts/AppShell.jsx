        ...
        <>
          ...
          >
            ...
            <div style={{ marginTop: '24px', textAlign: 'center', opacity: 0.2, fontSize: '10px', letterSpacing: '2px' }}>
              SPECTR CORE v4.9.3 // BUILD_STABLE
            </div>
            <button 
              onClick={() => window.scrollTo({ top: 500, behavior: 'smooth' })}
              style={{
                marginTop: '12px', width: '100%', padding: '12px', background: '#00FFFF', color: '#000',
                borderRadius: '12px', fontWeight: 800, fontSize: '12px'
              }}
            >
              DEBUG: FORCE SCROLL DOWN
            </button>
          </div>
        </>
      )}
